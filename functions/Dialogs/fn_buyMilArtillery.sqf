...
if (str (_display) != "no display") then
{
	...
	_ChildControl  ctrlSetTooltip format ["Cost: %1 P",[vehSDKHpodnos] call A3A_fnc_vehiclePrice];
	...
	_ChildControl  ctrlSetTooltip format ["Cost: %1 P",[SDKD30] call A3A_fnc_vehiclePrice];
	...
	_ChildControl  ctrlSetTooltip format ["Cost: %1 P",[vehSDKBM21] call A3A_fnc_vehiclePrice];
