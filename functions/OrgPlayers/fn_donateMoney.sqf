...
if (_resourcesPlayer < 100) exitWith {["Donate Money", "You have less than 100 P to donate"] call A3A_fnc_customHint;};
...
if (count _this == 0) exitWith
	...
	["Donate Money", "You have donated 100 P to the cause. This will raise your status among our forces"] call A3A_fnc_customHint;
	};
...
["Donate Money", format ["You have donated 100 P to %1", name _target]] call A3A_fnc_customHint;
