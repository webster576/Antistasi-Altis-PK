...
_vehNormal append [vehSDKTruck,vehSDKLightArmed,vehSDKAT,vehSDKGL,vehSDKATGM,vehSDKBMD,vehSDKBMP,vehSDKBTR,vehSDKZSU,vehSDKT72BA,vehSDKT72BB,vehSDK2S1,vehSDKBike,vehSDKRepair,vehSDKFuel,vehSDKAmmo,vehSDKHeal,vehSDKCarrier];
...
private _vehFIA = [vehSDKBike,vehSDKAT,vehSDKGL,vehSDKATGM,vehSDKBMD,vehSDKBMP,vehSDKBTR,vehSDKZSU,vehSDKT72BA,vehSDKT72BB,vehSDK2S1,vehSDKLightArmed,SDKAAStatic,SDKMGStatic,SDKMGStatic1,SDKATStatic,SDKGLStatic,vehSDKLightUnarmed,vehSDKTruck,vehSDKBoat,SDKMortar,staticATteamPlayer,staticAAteamPlayer,vehSDKRepair,vehSDKFuel,vehSDKAmmo,vehSDKHeal,vehSDKCarrier];
...
server setVariable [SDKATStatic,700,true];												//700
server setVariable [SDKAAStatic,1000,true];												//1000
server setVariable [vehSDKATGM,2000,true];												//2000
server setVariable [vehSDKBTR,2500,true];												//2500
server setVariable [vehSDKZSU,7000,true];												//7000
server setVariable [vehSDKBMP,10000,true];												//10000
server setVariable [vehSDKT72BA,30000,true];											//30000
server setVariable [vehSDKT72BB,50000,true];											//50000
server setVariable [vehSDK2S1,100000,true];												//100000

{server setVariable [_x,200,true]} forEach [civCar,civBoat,vehSDKHeal,vehSDKLightUnarmed];			//200
{server setVariable [_x,300,true]} forEach [vehSDKTruck,vehSDKFuel];			//300
{server setVariable [_x,400,true]} forEach [SDKMGStatic,SDKMGStatic1,vehSDKBoat,vehSDKRepair];			//400
{server setVariable [_x,500,true]} forEach [SDKGLStatic,vehSDKAmmo,vehSDKCarrier];			//500
{server setVariable [_x,700,true]} forEach [vehSDKLightArmed,vehSDKAT];
{server setVariable [_x,800,true]} forEach [vehSDKGL,SDKMortar,staticATteamPlayer,staticAAteamPlayer];			//800
