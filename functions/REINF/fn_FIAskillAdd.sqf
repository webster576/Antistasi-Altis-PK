...
if (_resourcesFIA < _costs) exitWith {["Skill Add", format ["You do not have enough money to afford additional training. %1 P needed",_costs]] call A3A_fnc_customHint;};
