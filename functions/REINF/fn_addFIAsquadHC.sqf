...
if (_resourcesFIA < _costs) then {_exit = true; ["Recruit Squad", format ["You do not have enough money for this request (%1 P required)",_costs]] call A3A_fnc_customHint;};
...
if (str (_display) != "no display") then {
	...
	_ChildControl  ctrlSetTooltip format ["Buy a vehicle for this squad for %1 P",_costs];
